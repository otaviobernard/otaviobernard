 ...
 * @author Frederico
 */
public class EncarregadoGrid extends javax.swing.JDialog {
    ...
    /**
     * Creates new form FornecedorGrid
     */
    public EncarregadoGrid(java.awt.Frame parent, boolean modal, IControleSimples controle, EncarregadoTableModel model) {
        super(parent, modal);
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        try {
            ...
            Encarregado aAlterar = model.getObjetoLinha(linha);
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        try {
            int linha = tblGrid.getSelectedRow();
            Encarregado aRemover = model.getObjetoLinha(linha);
...
//        controle.read(null);
        try {
            int linha = tblGrid.getSelectedRow();
            Encarregado aMostrar = model.getObjetoLinha(linha);
