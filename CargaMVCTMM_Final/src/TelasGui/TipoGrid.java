 ...
 * @author alessio
 */
public class TipoGrid extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public TipoGrid(java.awt.Frame parent, boolean modal, IControleSimples controle, TipoTableModel model) {
        super(parent, modal);
...
//        controle.read(null);
        try {
            ...
            Tipo aMostrar = model.getObjetoLinha(linha);
...
//        controle.update(null);
        try {
            int linha = tblGrid.getSelectedRow();
            Tipo aAlterar = model.getObjetoLinha(linha);
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        try {
            int linha = tblGrid.getSelectedRow();
            Tipo aRemover = model.getObjetoLinha(linha);
