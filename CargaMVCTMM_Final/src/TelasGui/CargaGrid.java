 ...
 * @author otávio
 */
public class CargaGrid extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public CargaGrid(java.awt.Frame parent, boolean modal, IControleSimples controle, CargaTableModel model) {
        super(parent, modal);
...
//    public CargaGrid(IControleSimples controle,
//            java.awt.Frame parent, boolean model) {
//        this(parent, model);
//        initComponents();
//        this.controle = controle;
//    }
    ...
    private void initComponents() {
        ...
        panPrincipalLayout.setVerticalGroup(
            ...
            .addGroup(panPrincipalLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(panGrid, javax.swing.GroupLayout.DEFAULT_SIZE, 84, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        try {
            ...
            Carga aAlterar = model.getObjetoLinha(linha);
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        ...
        try {
            int linha = tblGrid.getSelectedRow();
            Carga aRemover = model.getObjetoLinha(linha);
...
//        controle.read(null);
        try {
            int linha = tblGrid.getSelectedRow();
            Carga aMostrar = model.getObjetoLinha(linha);
...
//            java.util.logging.Logger.getLogger(CargaGrid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                CargaGrid dialog = new CargaGrid(new javax.swing.JFrame(), true);
