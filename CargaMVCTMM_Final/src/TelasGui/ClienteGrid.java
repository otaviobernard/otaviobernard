...
//    public ClienteGrid(IControleSimples controle,
...
//        controle.read(null);
        try {
            ...
            Cliente aMostrar = model.getObjetoLinha(linha);
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        try {
            int linha = tblGrid.getSelectedRow();
            Cliente aAlterar = model.getObjetoLinha(linha);
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        ...
        try {
            int linha = tblGrid.getSelectedRow();
            Cliente aRemover = model.getObjetoLinha(linha);
